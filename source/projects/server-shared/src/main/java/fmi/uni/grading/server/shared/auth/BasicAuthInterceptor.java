package fmi.uni.grading.server.shared.auth;
//package fmi.uni.grading.server.auth;
//
...
//
//	protected Logger log = Logger.getLogger(BasicAuthInterceptor.class
//			.getCanonicalName());
//
